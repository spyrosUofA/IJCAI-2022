...
class BottomUpSearch():
    ...
    def imitate_oracle(self, bound, eval_fn, operations, constant_values, observation_values, action_values, linear_values,
...
def algo_NDPS(oracle_path, seed, roll_outs=25, eps_per_rollout=25, pomd='CartPole-v1'):
    ...
    for r in range(roll_outs):
        # Imitation Step
        next_program, nb_evals = synthesizer.imitate_oracle(max_size, eval_fn, operations, constant_values, observation_values, action_values,
