...
class BottomUpSearch():
    ...
    def imitate_oracle(self, min_size, bound, eval_fn, operations, constant_values, observation_values, action_values, linear_values,
...
def algo_NDPS(oracle_path, seed, roll_outs=50, eps_per_rollout=2, pomd='LunarLander-v2'):
    ...
    for r in range(roll_outs):
        # Imitation Step
        next_program, nb_evals = synthesizer.imitate_oracle(min_size, max_size, eval_fn, operations, constant_values, observation_values, action_values,
                    linear_values, relu_programs, bo)
