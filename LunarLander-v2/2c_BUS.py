...
class BottomUpSearch():
    ...
    def imitate_oracle(self, min_size, bound, eval_fn, operations, constant_values, observation_values, action_values,
                       linear_values,
...
def algo_NDPS(oracle_path, seed, roll_outs=25, eps_per_rollout=25, pomd='LunarLander-v2'):
    ...
    # Specify DSL
    operations = [Ite, Lt]
    linear_values = [[0] * env.observation_space.shape[0]]
    constant_values = [0.0]
    ...
    for r in range(roll_outs):
        # Imitation Step
        next_program, nb_evals, best_score = synthesizer.imitate_oracle(min_size, max_size, eval_fn, operations, constant_values,
        ...
        print(r, best_reward, best_score)
